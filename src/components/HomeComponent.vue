  ...
  <div class="hello">
      ...
      <header id="site-header" class="fixed-top">
        <div class="container">
          <nav class="navbar navbar-expand-lg navbar-dark stroke">
            ...
            <button
              class="navbar-toggler bg-gradient"
              type="button"
    ...
    <section class="w3l-banner-main">
      ...
      <div class="bannerhny-content text-center">
        <h3 data-aos="fade-up">
          Manage your time, make <span>things</span><br />
          more oraganized.
        </h3>
        <h6 data-aos="fade-up">Click to Join the Advance Workshop</h6>
        <div class="banner-button" data-aos="fade-down">
          <a href="contact.html" class="btn">Join With Us</a
          ><small>for macOS / <a href="#">See all platforms</a></small>
        </div>
      </div>
      <!--//banner-content-->
    </section>
        ...
        <div class="container pt-lg-3">
          ...
          <div class="content-info-tabs mt-4">
            <div class="tab-main mx-auto text-md-center">
              ...
              <label for="tab1"
                ><span class="fa fa-lock" aria-hidden="true"></span> Create
                Account</label
              >

              <input id="tab2" type="radio" name="tabs" />
              <label for="tab2"
                ><span class="fa fa-credit-card" aria-hidden="true"></span> Make
                Payment</label
              >

              <input id="tab3" type="radio" name="tabs" />
              <label for="tab3"
                ><span class="fa fa-smile-o" aria-hidden="true"></span> Enjoy
                Yourself</label
              >
      ...
      <div class="content-photo-info py-5">
        <div class="container py-lg-3">
          ...
          <div class="content-photo-grids row mt-lg-5 mt-4 px-lg-5">
            ...
            <div
              class="photo-6-inf-right col-lg-6 text-left pl-lg-5"
              data-aos="fade-down"
            >
              <h4>Easy to Manage Your All Data by This App!</h4>
              <p>
          ...
          <!-- /row-->
          <div
            class="content-photo-grids row py-lg-5 py-4 mt-lg-5 mt-4 px-lg-5"
          >
            <div
              class="photo-6-inf-right col-lg-6 text-left pr-lg-5"
              data-aos="fade-down"
            >
              <h4>
                Easy to access and making purchases.
              </h4>
              <p>
                Lorem ipsum dolor sit amet consectetur adipisicing elit.
                Consequuntur hic odio voluptatem tenetur consequatur.Lorem ipsum
      ...
      <div class="macbook-infohny">
        ...
        <div class="container-fuild">
          <div class="row macbook-infohny-inn mx-lg-0">
            <div
              class="col-lg-6 macbook-left mt-lg-0 mt-5 px-lg-0"
              data-aos="fade-up"
            >
              <img src="assets/images/macbook-1.png" class="img-fluid" alt="" />
            </div>
            <div
              class="col-lg-6 macbook-right my-lg-5 py-lg-5 py-4"
              data-aos="fade-down"
            >
          ...
          <div class="content-info-in pt-5">
            <div class="content-gd pt-lg-5">
              <h3 class="hny-title" data-aos="fade-up">
                We exist to create things <br />people love
              </h3>
              <p data-aos="fade-up">
      ...
      <div class="footer-content py-lg-5 py-4 text-center">
        <div class="container">
          <div class="copy-right">
            <h6>
              Made with
              <span class="fa fa-heart" aria-hidden="true"></span> love Designed
